...
const Navbar = () => {
    ...
    return (
        <header className="absolute top-0 inset-x-0 z-50 h-24 flex items-center">
          ...
          `}>
                        <ul className="flex flex-col gap-y-5 text-white dark:text-white lg:items-center lg:flex-row lg:gap-x-5 lg:h-full lg:justify-center lg:flex-1">
                            <li>
                                <Link href="/" className="transition ease-linear hover:text-yellow-200 dark:hover:text-yellow-200">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="transition ease-linear hover:text-yellow-200 dark:hover:text-yellow-200">
                                    About
                                </Link>
                            </li>
                            <li>
                                <Link href="/services" className="transition ease-linear hover:text-yellow-200 dark:hover:text-yellow-200">
                                    Services
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="transition ease-linear hover:text-yellow-200 dark:hover:text-yellow-200">
                                    Contact
                                </Link>
                            </li>
                        </ul>
                        <div className="w-full flex sm:w-max lg:min-w-max lg:items-center">
                            <Link href="#" className="flex justify-center gap-x-3 items-center text-white dark:text-gray-300 hover:text-yellow-500 dark:hover:text-white
                    ...
                    <div className="flex items-center justify-end relative z-60 lg:hidden">
                        <button onClick={() => {
                            toggleNavbar()
                        }} className="p-3 rounded-full bg-transparent dark:bg-white outline-none w-12 aspect-square flex flex-col relative justify-center items-center">
